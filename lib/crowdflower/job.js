...
var Job  = function (api_key){
    ...
    else throw new Error('Missing API Key');
};
...
Object.defineProperty(Job.prototype, 'body', {
    'get': function () {
      var body = crowdflowerUrlEncode(this, ['job']);
 ...
 */
Job.prototype.uploadFile = function (filePath, force){
    if (!this.endpoint){
...
Job.prototype.uploadString = function (jsonString, force) {
  if (!this.endpoint){
    throw new Error("Cannot upload file. Missing job id.");
  }
  ...
  return rest.makePostRequest(path, jsonString, contentType)
    .then(
      handleJobJsonRepresentation.bind(this)
    );
};
