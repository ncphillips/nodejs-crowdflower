...
Job.prototype.resume = function (){
    return jobOperation.call(this, "resume")
        .then(
        rest.handleApplicationResponse
    );
};
...
Job.prototype.cancel = function (){
    return jobOperation.call(this, "cancel")
        .then(
        rest.handleApplicationResponse
    );
};
...
Job.prototype.status = function (){
    return jobOperation.call(this, "ping")
        .then(
        rest.handleJsonResponse
    );
};
...
Job.prototype.unitCount= function () {
    return jobOperation.call(this, "units/ping").then(
        rest.handleJsonResponse
    );
};
...
Job.prototype.fetchUnit = function (unitId) {
    ...
    var constructUnit = function(data){
        ...
        return Unit.call(unit, apiKey, jobId);
    };
 ...
 * Promises to return a Unit.
 */
Job.prototype.createUnit = function(template) {
    var unit = Unit.call(template, this.apiKey, this.id);
    if (unit) {
        return unit.update();
    }
};
